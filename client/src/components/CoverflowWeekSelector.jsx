...
export const WEEKS = [
  { number: 1, label: "Week 1", subtitle: "Kickoff Weekend", date: "Sept 5 - 7", badge: "LIVE NOW", tag: "MARQUEE", bg: "from-amber-900/40 via-black to-slate-900", highlight: "#f59e0b" },
  { number: 2, label: "Week 2", subtitle: "Non-Conf Showdowns", date: "Sept 12 - 14", badge: "UPCOMING", tag: "REGULAR", bg: "from-blue-950/50 via-black to-slate-900", highlight: "#38bdf8" },
  { number: 3, label: "Week 3", subtitle: "SEC Openers", date: "Sept 19 - 21", badge: "UPCOMING", tag: "REGULAR", bg: "from-red-950/50 via-black to-slate-900", highlight: "#f87171" },
  { number: 4, label: "Week 4", subtitle: "Conference Clashes", date: "Sept 26 - 28", badge: "UPCOMING", tag: "REGULAR", bg: "from-purple-950/50 via-black to-slate-900", highlight: "#c084fc" },
  { number: 5, label: "Week 5", subtitle: "Top 25 Showdowns", date: "Oct 3 - 5", badge: "UPCOMING", tag: "REGULAR", bg: "from-emerald-950/50 via-black to-slate-900", highlight: "#4ade80" },
  { number: 6, label: "Week 6", subtitle: "Midseason Surge", date: "Oct 10 - 12", badge: "UPCOMING", tag: "REGULAR", bg: "from-amber-950/50 via-black to-slate-900", highlight: "#fbbf24" },
  { number: 7, label: "Week 7", subtitle: "Rivalry Primers", date: "Oct 17 - 19", badge: "UPCOMING", tag: "REGULAR", bg: "from-cyan-950/50 via-black to-slate-900", highlight: "#22d3ee" },
  { number: 8, label: "Week 8", subtitle: "National Spotlight", date: "Oct 24 - 26", badge: "UPCOMING", tag: "REGULAR", bg: "from-indigo-950/50 via-black to-slate-900", highlight: "#818cf8" },
  { number: 9, label: "Week 9", subtitle: "Title Contenders", date: "Oct 31 - Nov 2", badge: "UPCOMING", tag: "REGULAR", bg: "from-orange-950/50 via-black to-slate-900", highlight: "#fb923c" },
  { number: 10, label: "Week 10", subtitle: "November Push", date: "Nov 7 - 9", badge: "UPCOMING", tag: "REGULAR", bg: "from-rose-950/50 via-black to-slate-900", highlight: "#fb7185" },
  { number: 11, label: "Week 11", subtitle: "Championship Hunt", date: "Nov 14 - 16", badge: "UPCOMING", tag: "REGULAR", bg: "from-blue-950/50 via-black to-slate-900", highlight: "#60a5fa" },
  { number: 12, label: "Week 12", subtitle: "Penultimate Tests", date: "Nov 21 - 23", badge: "UPCOMING", tag: "REGULAR", bg: "from-emerald-950/50 via-black to-slate-900", highlight: "#34d399" },
  { number: 13, label: "Week 13", subtitle: "Thanksgiving Feasts", date: "Nov 26 - 28", badge: "UPCOMING", tag: "RIVALRY", bg: "from-yellow-950/50 via-black to-slate-900", highlight: "#facc15" },
  { number: 14, label: "Week 14", subtitle: "Rivalry Weekend", date: "Dec 3 - 5", badge: "RIVALRY", tag: "IRON BOWL / RED RIVER", bg: "from-red-950/60 via-black to-slate-900", highlight: "#ef4444" },
  { number: 15, label: "CCG Week", subtitle: "Conference Titles", date: "Dec 10 - 12", badge: "CHAMPIONSHIPS", tag: "SEC / B1G / ACC / B12", bg: "from-purple-950/60 via-black to-slate-900", highlight: "#a855f7" },
