    ...
    const scheduleList = schedules.map(s => {
      ...
      if (userPick) {
        ...
        userPrediction = {
          ...
          predicted_winner_id: userPick.predicted_winner_id,
          predicted_winner_name: userPick.predicted_winner_name,
          confidenceLevel: userPick.confidence_level || userPick.confidence_points || null,
          confidence_level: userPick.confidence_level || userPick.confidence_points || null,
          confidencePoints: userPick.confidence_points || userPick.confidence_level || 1,
          confidence_points: userPick.confidence_points || userPick.confidence_level || 1,
          isWinForTeam: isWin,
